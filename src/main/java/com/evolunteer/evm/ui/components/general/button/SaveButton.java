...
public class SaveButton extends Button{
    ...
    private void init() {
        ...
        final String messageText = messageSource.getMessage(LocalizationUtils.UI.CommonText.SAVE_BUTTON_TEXT, null, locale);
        this.setIcon(new Icon(VaadinIcon.DOWNLOAD_ALT));
